...
type Inbound struct {
	...
	UserId               int                  `json:"-" gorm:"index"`                                                                                  // Associated user ID
...
// ClientDevice tracks unique devices connecting to inbound clients.
// Enables device-level monitoring beyond simple IP tracking.
